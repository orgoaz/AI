...
class BusProblem(Problem):
    ...
    def _getNewStateAtLoc(self, previousState, newLoc):
        ...
        pickedUp = [o for o in previousState.waitingOrders if o[0] == newLoc]
        droppedOff = [o for o in previousState.ordersOnBus if o[1] == newLoc]

        newWaiting = [o for o in previousState.waitingOrders if o not in pickedUp]
        newOnBus = [o for o in previousState.ordersOnBus if o not in droppedOff] + pickedUp
        newFinished = previousState.finishedOrders + droppedOff
